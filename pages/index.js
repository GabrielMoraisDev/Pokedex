...
export default function Home() {
  ...
  return (
    ...
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-b from-slate-700 to-slate-900 bg-no-repeat bg-center bg-cover" style={{ backgroundImage: 'url(/background.gif)' }}>
      <div className={`${openPokedex && 'bg-black/65'} h-full w-full absolute duration-1000`}></div>
      <div className={`w-[40rem] h-[45rem] ${PokeMenu2 && 'ml-[-15rem]'} duration-1000 relative`}>
        ...
        <Image className={`absolute z-30 ${openPokedex && 'h-[45rem] w-0 ml-[27rem]'} duration-300`} width={500} height={900} alt="" src={'/tamp.webp'} onClick={()=>setOpenPokedex(true)}/>
